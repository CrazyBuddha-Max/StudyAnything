...
client = openai.OpenAI(
    api_key="sk-ece2fc260245421994110309cb0b6aea", base_url="https://api.deepseek.com"
)
            ...
            for result in search_res["results"]:
                ...
                response = client.chat.completions.create(  # noqa: F841
                    ...
                    messages=[
                        {
                            "role": "system",
                            "content": "你是一个情报专家。请对照[新闻类型准则]判定此内容是否符合要求。要求如下：1.政策法规 2.竞品扩张...",
                        },
                        {
                            "role": "user",
                            "content": f"新闻正文：{content[:4000]}",
                        },  # 截取前4k字防溢出
                    ],
                )
